...
#define WWW_FORM_CHARSET	HTAtom_for("application/x-www-form-urlencoded; charset=utf-8")
#define WWW_JSON	HTAtom_for("application/json")
...
#define WWW_MULTIPART_FORM  HTAtom_for("multipart/form-data; boundary=Boundary+123456789")
...
/*
  ...
  @(#) $Id: HTFormat.html,v 2.85 2000/12/18 17:00:56 kahan Exp $
