...
int main (int argc, char ** argv)
{
    ...
    HTRequest_addExtraHeader(request, "Content-Type", "multipart/form-data; boundary=Boundary+123456789");
    HTRequest_addExtraHeader(request, "BOUNDARY", "--boundary=Boundary+123456789");
    HTRequest_addExtraHeader(request, "Content-Disposition", "form-data; name=\"acl\"\r\npublic-read");
    HTRequest_addExtraHeader(request, "BOUNDARY", "--boundary=Boundary+123456789");
    //HTRequest_addExtraHeader(request, "policy", "");
    //HTRequest_addExtraHeader(request, "AWSAccessKeyId", "AKIAJU4QFMN2ISKPR4FQ");
    //HTRequest_addExtraHeader(request, "acl", "public-read");
    //HTRequest_addExtraHeader(request, "success_action_status", "201");
    //HTRequest_addExtraHeader(request, "key", "upload/1/sleep/ting");
    //HTRequest_addExtraHeader(request, "signature", "B0i2stP55ncgrXmuhYUY9xMVxqA=");
    //HTRequest_addExtraHeader(request, "file", "[]");
	...
	*/
	...
	HTAnchor_setFormat(src, WWW_MULTIPART_FORM);
